...
const CommentItem = ({
  ...
  const getCommentBackground = () => {
    if (parentCommentId === comment.id) return colors.ORANGE_100;
    if (isReply) return colors.GRAY_50;
    return colors.WHITE;
  };
    ...
    >
      <View style={styles.profileContainer}>
        ...
        <Profile
          ...
          onPress={() => {
            if (!comment.isDeleted) router.push(`/profile/${comment.user.id}`);
          }}
          option={
